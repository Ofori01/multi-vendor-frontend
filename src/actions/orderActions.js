...
export const payOrder = (updatedStatus, order) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    const { data } = await axios.put(
      `/api/order/update/${order.order_id}`,
      updatedStatus,
      config
    );
...
export const cancelOrder = (order_status, order) => async (dispatch, getState) => {
  try {
      dispatch({
